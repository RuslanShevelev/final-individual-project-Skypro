...
import { useUploadAvatarMutation } from 'services/appService'
  ...
  return (
    <div className={styles.container_enter}>
      <div className={styles.modal__block}>
        <form
          className={styles.modal__formLogin}
          onSubmit={(e) => {
            e.preventDefault()
            sendAvatar()
          }}
        ...
        >
          ...
          {data.isLoading ? (
            ...
            <>
              ...
              <p>
                <label className={styles.modal__btnEnter} htmlFor="image">
                  {fileDataURL ? 'Выбрать другой файл' : 'Выберите файл'}
                </label>
                <input
                  type="file"
                  style={{ display: 'none' }}
