    ...
    return (
        <>
                ...
                <div className={classNames(styles.artic__content, styles.article)}>
                    <div className={styles.article__left}>
                        <div className={styles.article__fillImg}>
                            ...
                            <div className={classNames(styles.article__imgBarMob, styles.imgBarMob)}>
                                <div className={classNames(styles.imgBarMob__circle, styles.circleActive)} />
                    ...
                    <div className={styles.article__right}>
                        <div className={styles.article__block}>
                            ...
                            <div className={styles.article__info}>
                                ...
                                <a className={styles.article__link} href="" target="_blank" rel="">
                                    23 отзыва
                                </a>
                            </div>
                            <p className={styles.article__price}>2 200 ₽</p>
                            <button className={classNames(styles.article__btn, styles.btnHov02)}>
                                Показать&nbsp;телефон
                                <span>8&nbsp;905&nbsp;ХХХ&nbsp;ХХ&nbsp;ХХ</span>
                            </button>
                            {/* <MyButton name={`Показать&nbsp;телефон
                                <span>8&nbsp;905&nbsp;ХХХ&nbsp;ХХ&nbsp;ХХ</span>` }/> */}
                            <div className={classNames(styles.article__author, styles.author)} >
            ...
            <div className={styles.main__container}>
                <h3 className={classNames(styles.main__title, styles.title)}>Описание товара</h3>
